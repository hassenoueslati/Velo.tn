        ...
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <form action="/search" class="navbar-form navbar-left">
                <div class="form-group">
                    <input type="text" name="query" class="form-control search-bow " placeholder="search">
                </div>
                    ...
                    <div class="form-group">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="prixPromotion" id="prixPromotion"  ></td>
                            </tr>
                            ...
                            <td><input type="text" name="etatPromotion" id="etatPromotion"  ></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><label>descriptionPromotion :</label></td>
                                <td> <input type="text" name="descriptionPromotion" id="descriptionPromotion" cols=23 >

                                    </input></td></tr>

                    </div>
                    <tr>
                        <td clospan="2"><button type="submit" class="btn btn-primary">Add</button></td></tr>
                ...
                <div class="col-lg-6 pt-4" style="min-height: 400px;">
                    <div class="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="position-absolute top-0 end-0 mt-n4 me-n4 py-4 px-5" style="background: rgba(0, 0, 0, .08);">
                            ...
                            <h4 class="text-white">{{$item['nomPromotion']}}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <h6 class="text-primary text-uppercase">{{$item['category']}}</h6>
                    <h1 class="mb-4"><span class="text-primary">{{$item['prixPromotion']}}</span> TND</h1>
                    <p class="mb-4">{{$item['descriptionPromotion']}}</p>
