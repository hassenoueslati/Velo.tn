    ...
    <div class="form-group">
        <table>
            <tr>
                ...
                <td><input type="date" name="dateDebut"  class=form-control id="dateDebut" value="{{ $reservation->dateDebut }}"  ></td>

            </tr>
            <tr>
                <td><label>Date Fin:</label></td>
                <td><input type="date" name="dateFin" class=form-control id="dateFin" value="{{ $reservation->dateFin }}" ></td>
            </tr>

            <tr>
                <td><label>Description:</label></td>

                <td><input type="text" name="description" class=form-control id="description" value="{{ $reservation->description }}" ></td>
            </tr>
