...
<body>
    ...
    <Table>
        ...
        <tr>
            ...
            <td>{{$evenement->categorieEvenement}}</td>
            <td> <a href="{{route('deleteEvenement',$evenement->id)}}">Delete</a>
                <a href="{{route('editEvenement',$evenement->id)}}">Update</a>  </td>

        </tr>
        @endforeach
        <td><a href="{{route('createEvenement')}}">Add</a>  </td></td>
    </Table>
